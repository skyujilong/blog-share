...
// resovle相关配置
const resovle = require('./webpack-cfg/resolve.conf.js');
// 服务器配置
...
module.exports = (env) => {
    ...
    switch (runMode) {
        ...
        case 'dev-hmr':
            // 启用热部署替换的开发服务
            webpackConfig = baseMerge(commonConf, spritePlugins, entryConf, hmrConf, resovle, htmlPlugins, devServerConf);
            break;
        case 'dev-watch':
            // 启用watch的本地文件模式
        ...
        case 'prod':
            ...
            webpackConfig = baseMerge(commonConf, entryConf, prodConf, resovle, htmlPlugins);
            break;
    }
